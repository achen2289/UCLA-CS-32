...
#include "Game.h"
#include "globals.h" // for MAXVAMPIRES, EMPTY
#include "Arena.h" // in addition to forward declaration
#include "Player.h" // Player class member functions used
#include <iostream>
using namespace std;
...
string Game::takePlayerTurn()
{
    for (;;)
    {
        bool history_selected = false; // whether or not user enters 'h'
