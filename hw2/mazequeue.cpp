...
bool pathExists(string maze[], int nRows, int nCols, int sr, int sc, int er, int ec)
{
    ...
    queue<Coord> coordinate; // queue of Coord objects to store coordinates
    ...
    {
        // take row and column of top of queue
        curR = coordinate.front().r();
        curC = coordinate.front().c();
        coordinate.pop(); // remove coordinate from queue
