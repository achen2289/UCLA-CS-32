...
//int main()
//{
//    ExpandableHashMap<string, double> nameToGPA(0.7);
//    cout << nameToGPA.size() << endl;
//    nameToGPA.associate("Alex", 1.0);
//    nameToGPA.associate("Bob", 2.0);
//    nameToGPA.associate("Cam", 3.0);
//    nameToGPA.associate("Dorn", 4.0);
//    nameToGPA.associate("For", 4.0);
//    nameToGPA.associate("God", 4.0);
//    nameToGPA.associate("sdod", 4.0);
//    nameToGPA.associate("sadfd", 4.0);
//    double* rest = nameToGPA.find("Bob");
//    if (rest != nullptr)
//        cout << *rest << endl;
//    nameToGPA.associate("Ep", 5.0);
//    if (rest != nullptr)
//        cout << *rest << endl;
//
//}
